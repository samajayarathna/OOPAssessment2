...
class Driver():
    ...
    def addDemeritPoints(self,newValue):
        ...
        if totalDemeritPoints > self.maxDemeritPoints:
            ...
            # print("successfully updated demerit points")
            # print("New Demerit Points :", totalDemeritPoints)
...
class Car(Vehicle):
    ...
    #     Vehicle.displayVehicleData(self)
    #     print("General data: body type ", self.bodyType, ", colour ", self.colour,"," ,self.uphostery,",", self.NoOfDoors, "doors.")
...
def main():
    ...
    # print("\nDriver 2 demerit points after decrementing 3 points :")
    # driver2.displayDemeritPoints()
